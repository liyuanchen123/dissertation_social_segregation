...
def train_sdcn(dataset):
    ...
    print(pred.shape)
    torch.save(pred.data.cpu().numpy().argmax(1), 'resulttest.pt')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--n_input', default=20, type=int)
